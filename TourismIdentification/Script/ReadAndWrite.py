...
def read_from_db_write_to_file():
    test_weibos = DatabaseHelper.get_weibos('suzhou_weibos_only_sure_test_1224')
    train_weibos = DatabaseHelper.get_weibos('suzhou_weibos_only_sure_train_1224')
